...
import com.example.chapter05_project_mvvm.databinding.RepoItemBinding;
import com.example.chapter05_project_mvvm.model.GitHubService;
import com.example.chapter05_project_mvvm.viewmodel.RepositoryItemViewModel;
...
public class RepositoryAdapter extends RecyclerView.Adapter<RepositoryAdapter.RepoViewHolder> {
    ...
    public RepoViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        Log.d("hj_test","RepositoryAdapter - OnCreateViewHolder");
    ...
    public void onBindViewHolder(final RepoViewHolder holder, final int position) {
        Log.d("hj_test","RepositoryAdapter - onBindViewHolder");
    ...
    static class RepoViewHolder extends RecyclerView.ViewHolder {
        ...
        public void loadItem(GitHubService.RepositoryItem item) {
            Log.d("hj_test","RepositoryAdapter - loadItem");
