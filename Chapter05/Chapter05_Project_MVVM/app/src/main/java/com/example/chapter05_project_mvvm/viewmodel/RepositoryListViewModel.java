package com.example.chapter05_project_mvvm.viewmodel;
...
public class RepositoryListViewModel {
    ...
    // 프로그래스 바 , 필요한
    public final ObservableInt progressBarVisibility = new ObservableInt(View.VISIBLE); // 뷰에  연결할 데이터
    ...
    public RepositoryListViewModel(RepositoryListViewContract repositoryListView, GitHubService gitHubService) {
        this.repositoryListView = repositoryListView; // 명령
    ...
    private void loadRepositories(String langugae) {
        ...
        Log.d("hj_check","RepositoryListViewModel - listRespos 호출");
